...
public class TrackManager : MonoBehaviour
{
    ...
    private Queue<Plane> _planes = new();
    private Plane _firstPlane, _currPlane, _lastPlane;
    ...
    void Start()
    {
        ...
        {
            Plane plane2 = Instantiate(plane);
            plane2.trackManager = this;
            if (_lastPlane == null)
            {
                _firstPlane = plane2;
                _currPlane = plane2;
    ...
    private void SetNextPlane(Plane plane2)
    {
